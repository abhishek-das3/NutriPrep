				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Dietitian | Edit Dietitian Details</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Dietitian</span>
									...
									<li class="active">
										<span>Edit Dietitian Details</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Dietitian</h5>
												</div>
...
<div class="form-group">
															<label for="address">
															Dietitian Clinic Address
															</label>
					<textarea name="clinicaddress" class="form-control"><?php echo htmlentities($data['address']);?></textarea>
														</div>
<div class="form-group">
															<label for="fess">
															Dietitian Consultancy Fees
															</label>
