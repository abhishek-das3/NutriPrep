...
<html lang="en">
	<head>
		<title>Admin | Manage Dietitian</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Manage Dietitian</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
						...
						<div class="container-fluid container-fullw bg-white">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Dietitian</span></h5>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th class="hidden-xs">Dietitian Name</th>
												<th>Creation Date </th>
												<th>Action</th>
