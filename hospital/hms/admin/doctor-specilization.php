...
<html lang="en">
	<head>
		<title>Admin | Dietitian Specialization</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Add Dietitian Specialization</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Add Dietitian Specialization</span>
									</li>
								</ol>
							</div>
						</section>
						...
						<div class="container-fluid container-fullw bg-white">
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Dietitian Specialization</h5>
												</div>
							...
							<input type="text" name="doctorspecilization" class="form-control"  placeholder="Enter Doctor Specialization">
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Dietitian Specialization</span></h5>
